(function() {
    ...
    async function checkStatus() {
        ...
        if (!its) {
            showDialog({
                variant: 'danger',
                title: 'ITS Required',
                message: 'Please enter your 8-digit ITS number to track your status.',
                confirmLabel: 'OK'
            });
            return;
        }
    ...
    async function requestCancel(dutyId) {
        ...
        showDialog({
            ...
            message: 'Are you sure you want to request cancellation for this Khidmat?',
                ...
                try {
                    ...
                    if (res.ok) {
                        ...
                        showDialog({
                            ...
                            message: data.error || data.message || "Unable to submit request.",
    ...
    async function requestReallocation(dutyId) {
        ...
        showDialog({
            ...
            message: 'Are you sure you want to request reallocation for this Khidmat?',
                ...
                try {
                    ...
                    if (res.ok) {
                        showDialog({
                            variant: 'success',
                            title: 'Request Submitted',
                            message: data.message || "Reallocation request submitted successfully.",
                            confirmLabel: 'OK',
                            onConfirm: () => checkStatus()
                        });
                    } else {
