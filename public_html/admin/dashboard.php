...
<div class="min-h-screen bg-[#F9F7F7]">
            ...
            <div>
                <div class="flex flex-col md:flex-row md:items-center gap-2 md:gap-6 mb-1">
                    ...
                    <div class="flex items-center gap-2 mt-2 md:mt-0 md:ml-4 overflow-x-auto pb-2 md:pb-0">
                        <a href="<?= BASE_URL ?>/admin/dashboard.php" class="whitespace-nowrap px-3 py-1.5 rounded-md bg-[#3F72AF] text-white text-sm font-medium flex items-center gap-2">
                        ...
                        <a href="<?= BASE_URL ?>/admin/master-sheet.php" class="whitespace-nowrap px-3 py-1.5 rounded-md text-[#DBE2EF] hover:text-white hover:bg-white/10 text-sm font-medium transition-all flex items-center gap-2">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="8" y1="13" x2="16" y2="13"></line><line x1="8" y1="17" x2="16" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                            Master Sheet
                        </a>
                        <a href="<?= BASE_URL ?>/admin/khidmat-requests.php" class="whitespace-nowrap px-3 py-1.5 rounded-md text-[#DBE2EF] hover:text-white hover:bg-white/10 text-sm font-medium transition-all flex items-center gap-2">
    ...
    <div class="p-6">
        ...
        <div id="roster-grid-container" class="hidden bg-white shadow-lg border border-[#DBE2EF] rounded-lg">
            <div class="responsive-table-container custom-scrollbar md:max-h-[calc(100vh-220px)]">
