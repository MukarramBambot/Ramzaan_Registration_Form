    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto space-y-6">
            ...
            <div id="success-view" class="hidden w-full bg-white rounded-lg shadow-sm border border-[#DBE2EF] overflow-hidden text-center p-12">
                ...
                <div class="mt-4">
                    <a href="<?= BASE_URL ?>/khidmat/status.php" class="text-[#112D4E] text-sm hover:underline">Check Allocation Status</a>
                </div>
            </div>
            ...
            <section class="khidmat-practice-section bg-white rounded-lg shadow-sm border border-[#DBE2EF] overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <ul class="space-y-3">
                        <li class="p-3 border border-[#E6EDF7] rounded flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                            <div class="flex-1">
                                <strong class="text-[#112D4E]">Azaan:</strong>
                                <div class="text-sm text-[#6B7280]">Practice Audio</div>
                            </div>
                            <div class="w-full sm:w-auto">
                                <a href="https://drive.google.com/file/d/1Ijx6b1ukpBc2beqkRbQviOy0H00pzlPd/view?usp=drive_link" target="_blank" rel="noopener noreferrer" class="block text-center px-4 py-2 bg-[#DBE2EF] sm:bg-transparent text-[#3F72AF] rounded-md sm:rounded-none hover:underline text-sm font-medium">Recordings</a>
                            </div>
                        </li>
                        ...
                        <li class="p-3 border border-[#E6EDF7] rounded flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                            ...
                            <div class="w-full sm:w-auto">
                                <a href="https://drive.google.com/file/d/1weYoZvBeif_pDdkv4riFLfCvAUy0C-JN/view?usp=drive_link" target="_blank" rel="noopener noreferrer" class="block text-center px-4 py-2 bg-[#DBE2EF] sm:bg-transparent text-[#3F72AF] rounded-md sm:rounded-none hover:underline text-sm font-medium">Recordings</a>
                            </div>
                        </li>
                        ...
                        <li class="p-3 border border-[#E6EDF7] rounded flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                            ...
                            <div class="w-full sm:w-auto">
                                <a href="https://youtu.be/qwXfSJ4uG-Y?si=b7s8XDt4FJNgrq4D" target="_blank" rel="noopener noreferrer" class="block text-center px-4 py-2 bg-[#DBE2EF] sm:bg-transparent text-[#3F72AF] rounded-md sm:rounded-none hover:underline text-sm font-medium">Watch Reference</a>
                            </div>
                        </li>
                        ...
                        <li class="p-3 border border-[#E6EDF7] rounded flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                            ...
                            <div class="w-full sm:w-auto">
                                <a href="https://drive.google.com/drive/folders/1uVSCvLv_QBgOjl8DZXjWtYnqaa2HPTRd?usp=drive_link" target="_blank" rel="noopener noreferrer" class="block text-center px-4 py-2 bg-[#DBE2EF] sm:bg-transparent text-[#3F72AF] rounded-md sm:rounded-none hover:underline text-sm font-medium">Open Folder</a>
                            </div>
                        </li>
                    </ul>
            ...
            <form id="registration-form" class="bg-white rounded-lg shadow-sm border border-[#DBE2EF] overflow-hidden">
                ...
                <div class="p-8 space-y-8">
                    ...
                    <div class="space-y-2">
                        <label class="block text-xs font-bold text-[#6B7280] uppercase tracking-wider">
                            Upload Audition Files
                        </label>
                        <p class="text-sm text-[#9CA3AF] mb-2">Audio files only. Optional. Max 6 files. Max 15MB each.</p>
                    ...
                    <div class="pt-4">
                        ...
                        <div class="text-center mt-4">
                            <a href="<?= BASE_URL ?>/khidmat/status.php" class="text-[#3F72AF] text-sm hover:underline">Already registered? Check status</a>
                        </div>
                    </div>
