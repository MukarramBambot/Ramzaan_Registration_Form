...
# Setup Django Logging for Production
import os
LOGGING = {
    'version': 1,
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'vajebaat.log'),
            'formatter': 'verbose',
        },
    },
    'loggers': {
...
# GOOGLE SHEETS
GOOGLE_SHEET_ID = os.getenv('GOOGLE_SHEET_ID', 'your-spreadsheet-id-here')
GOOGLE_SHEETS_CREDENTIALS = os.getenv('GOOGLE_SHEETS_CREDENTIALS')
GOOGLE_SERVICE_ACCOUNT_FILE = (
    GOOGLE_SHEETS_CREDENTIALS
    or os.path.join(BASE_DIR, "credentials/google-sheets.json")
)
